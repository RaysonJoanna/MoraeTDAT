...
<body>
    <div>
        ...
        <p class="h4 text-center fw-bold">전화번호 변경</p>
    </div>
    <div style="width:600px;" class="p-5 mt-3" id="beforeFind">
        ...
        <div class="btn_confirm mb-5 d-flex justify-content-center">
            <button type="button" class="btn border btn-mb mt-4" onclick="changingPhone()" style="background-color: #ebebeb">전화번호 변경</button>
        </div>
    </div>
</body>
</html>